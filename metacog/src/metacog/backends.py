"""Swappable LLM backends for the pressure-test engine.
...
- OllamaBackend: a local Ollama server (default http://localhost:11434),
  for fully offline runs on your own machine.
...
class StubBackend:
    ...
    def __init__(self, record_json: dict) -> None:
        self._record_json = record_json

    def complete(self, system: str, user: str) -> str:
        return json.dumps(self._record_json)
...
class OpenRouterBackend:
    ...
    OPENROUTER_MODEL selects the model.
    """
